...
parser.add_argument('--root_path', type=str, default='C:/PycharmProjects/dataset/Prostate', help='Name of Experiment')
parser.add_argument('--exp', type=str, default='Prostate/test', help='experiment_name')
parser.add_argument('--model', type=str, default='unet', help='model_na`me')
...
def Inference(FLAGS):
    ...
    test_save_path = "./model/{}_{}_labeled/predictions/".format(FLAGS.exp,FLAGS.labeled_num)
    if os.path.exists(test_save_path):
        shutil.rmtree(test_save_path)
    os.makedirs(test_save_path)
    logging.basicConfig(filename=snapshot_path + "/prostate_detail.txt", level=logging.INFO,
